            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                    	<h4 class="card-title">REPORTES DE SERVICIO MÁS COTIZADO</h4>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <table id="tbl_servicio_mas_cotizado" class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>SERVICIO</th>
...
<?php $this->load->view("reporte/sistemas/servicio/include/servicio_mas_cotizado_script"); ?>