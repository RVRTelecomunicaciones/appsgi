            ...
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">
                        Cliente con más servicios realizados / Particulares
                    </li>
                </ol>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                    	<h4 class="card-title">REPORTE DE CLIENTE CON MÁS SERVICIOS REALIZADOS - PARTICULARES</h4>
...
<?php $this->load->view("reporte/sistemas/cliente/particular/include/mayor_servicio_solicitado_script"); ?>