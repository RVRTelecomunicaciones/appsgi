            ...
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">
                        Resumen de ventas por servicios
                    </li>
                </ol>
            </div>
        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <table id="tbl_ventas_por_servicio" class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <th rowspan="2">#</th>
...
<?php $this->load->view("reporte/sistemas/venta/include/venta_servicio_script"); ?>