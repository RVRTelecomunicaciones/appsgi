        ...
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="<?= base_url($modulo.'/coordinacion') ?>">Coordinación</a>
                    </li>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-11">
                                            <a id="lnkResumen" href="" class="btn btn-outline-secondary square float-right"><i class="fa fa-file-text-o"></i> Resumen</a>

                                            <a id="lnkExportXls" href="" class="btn btn-outline-success square float-right mr-1"><i class="fa fa-file-excel-o"></i> Exportar Excel</a>
                                            ...
                                            <div class="mega-dropdown-menu dropdown-menu" style="width: 400px;">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="center">
                                                        <form id="frm_filtros">
                                                            <div class="row <?php //if ($this->session->userdata('usu_id') != '67') { echo 'hidden'; } ?>">
                                                                <div class="col-md-12">
                                                                    <div class="input-group input-group-sm">
                                                                        ...
                                                                        <select id="selectFechaTipo" class="form-control form-control-sm">
                                                                            ...
                                                                            <option value="3" selected>Fecha Creación</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                            </div>
                                    ...
                                    <table id="tbl_coordinacion" class="table table-striped table-bordered table-responsive">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th width="80" rowspan="2" style="cursor: pointer;" class="icono" data-index="2">ESTADO <i id="iconEstado"></i></th>
                                                ...
                                                <th width="80" rowspan="2" style="cursor: pointer;" class="icono" data-index="10">FECHA DE CREACIÓN <i id="iconFechaCreacion"></i></th>
                                            </tr>
                                            <tr>
                                                <th>UBICACIÓN</th>
...
<?php $this->load->view("reporte/coordinacion/generadas/include/generadas_script"); ?>
