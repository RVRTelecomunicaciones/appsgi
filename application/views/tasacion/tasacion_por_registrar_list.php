                                    ...
                                    <table id="tbl_tasacion" class="table table-striped table-bordered table-responsive">
                                        <thead>
                                                    ...
                                                    <?php
                                                        if (count($ccalidad) > 0){
                                                            foreach ($ccalidad as $row) {
                                                                if ($row->perito_id == $this->session->userdata('usu_id')) {
                                                                    echo '<option value="'.$row->control_calidad_id.'" selected>'.strtoupper($row->control_calidad_nombre).'</option>';
                                                                } else {
                                            ...
                                            <tr>
                                                ...
                                                <th width="<?= buscarPermisoEscritura(15, $this->session->userdata('usu_permiso')) == '1' ? '450' : '500'; ?>">SOLICITANTE</th>
                                                <th width="<?= buscarPermisoEscritura(15, $this->session->userdata('usu_permiso')) == '1' ? '450' : '500'; ?>">CLIENTE</th>
                                                <th width="150">PERITO</th>
                                                <th>CONTROL DE CALIDAD</th>
                                                <th width="80">FECHA</th>
                                                <th id="thCoordinacion" class="<?= buscarPermisoEscritura(15, $this->session->userdata('usu_permiso')) == '1' ? '' : 'hidden'; ?>">ACCIONES</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        </tbody>
...
<?php $this->load->view("tasacion/include/tasacion_por_registrar_script"); ?>