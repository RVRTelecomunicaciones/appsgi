<div class="modal fade text-left" id="mdlClase" role="dialog" aria-labelledby="myModalLabel8" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary white">
                <h4 class="modal-title" id="myModalLabel8">MANTENIMIENTO DE CLASE</h4>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table id="tbl_tasacion_clase" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        <td colspan="2">
