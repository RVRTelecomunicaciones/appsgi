<div class="modal fade text-left" id="mdlTNRegistrado" role="dialog" aria-labelledby="myModalLabel8" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary white">
                <h4 class="modal-title" id="myModalLabel8">MANTENIMIENTO DE TIPO</h4>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <form id="frm_tipo_otras_tasaciones">
                            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table id="tbl_tasacion_no_registrado" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        <td colspan="2">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="text-left">
                            <span id="conteo_clase"></span>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div id="paginacion_clase" class="float-right"></div>
                    </div>
                </div>
            </div>
