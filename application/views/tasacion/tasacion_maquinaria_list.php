        ...
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="<?= base_url('tasacion/maquinarias') ?>">Registradas</a>
                    </li>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                    	<h4 class="card-title">TASACIONES REGISTRADAS - MAQUINARIAS</h4>
...
<?php $this->load->view("tasacion/include/tasacion_maquinaria_script"); ?>