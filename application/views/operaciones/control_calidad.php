                                    ...
                                    <table id="tbl_coordinacion" class="table table-striped table-bordered table-responsive">
                                        <thead>
                                            <tr>
                                                ...
                                                <td>
                                                    <!--<div class="<?php if ($this->session->userdata('usu_id') != 67 && $this->session->userdata('usu_id') != 41) echo 'hidden';?>">
                                                        <select id="selectDigitador" class="form-control">
                                                            <option value=""></option>
                                                        <?php
                                                            if (count($perito) > 0){
                                                                foreach ($perito as $row) {
                                                                    if ($row->perito_id == $this->session->userdata('usu_id') && $row->perito_id != 67) {
                                                        ...
                                                        <?php
                                                            if (count($control_calidad) > 0){
                                                                foreach ($control_calidad as $row) {
                                                                    if ($row->control_calidad_id == $this->session->userdata('usu_id') && $row->control_calidad_id != 67 && $row->control_calidad_id != 41) {
...
<?php $this->load->view("operaciones/include/control_calidad_script"); ?>
