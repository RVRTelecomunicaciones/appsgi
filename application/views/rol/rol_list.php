            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                    	<h4 class="card-title">REPORTE DE ROLES</h4>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-2">
                                            <a id="lnkNuevo" href="" class="btn btn-info <?= buscarPermisoEscritura(3, $this->session->userdata('usu_permiso')) == '1' ? '' : 'hidden'; ?>">Nuevo <i class="fa fa-plus"></i></a>
                                        </div>
                                        <!--<div class="col-md-9">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <table id="tbl_rol" class="table table-striped table-bordered table-responsive">
                                        <thead>
                                            <tr id="test">
                                                <td colspan="2"><input type="text" class="form-control form-control-sm" id="inputSearchDescripcion"></td>
                                            </tr>
                                            <tr>
                                                <th>#</th>
                                                <th width="10000">DESCRIPCIÓN</th>
                                                <th class="<?= buscarPermisoEscritura(3, $this->session->userdata('usu_permiso')) == '1' ? '' : 'hidden'; ?>">ACCIONES</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        </tbody>
...
<?php $this->load->view("rol/modal/rol_modal"); ?>
<?php $this->load->view("includes/include_script_datatable"); ?>
<?php $this->load->view("rol/include/rol_script"); ?>
