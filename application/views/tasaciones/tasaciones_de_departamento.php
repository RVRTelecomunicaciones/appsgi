        ...
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Lista de Tasaciones de Departamento
                    </li>
                </ol>
            </div>
        </div>
        <h3 class="content-header-title mb-0">Tasaciones de Departamento</h3>
    </div>
</div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">TASACIONES ANTERIORES</h4>
...
<script src="<?= base_url() ?>assets/js/system/tasacion/tasacionesDepartamento.js"></script>
