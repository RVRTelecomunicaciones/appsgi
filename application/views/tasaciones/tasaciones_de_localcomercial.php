        ...
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Lista de Tasaciones de Locales Comerciales
                    </li>
                </ol>
            </div>
        </div>
        <h3 class="content-header-title mb-0">Tasaciones de Locales Comerciales</h3>
    </div>
</div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">TASACIONES LOCALES COMERCIALES</h4>
                        ...
                        <div class="card-body">
                            <table id="datatable-buttons" class="table table-striped table-bordered text-inputs-searching" style="width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control" id="inputVistaLocal"></td>
...
<script src="<?= base_url() ?>assets/js/system/tasacion/tasacionesLocalComercial.js"></script>
