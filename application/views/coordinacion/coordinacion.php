                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="input-group input-group-sm">
                                                                        ...
                                                                        <select id="selectFechaTipo" class="form-control form-control-sm">
                                                                            ...
                                                                            <option value="1">Fecha de entrega cliente</option>
                                                                            <option value="2">Fecha Inspeccion</option>
                                                                            <option value="4">Fecha entrega Operaciones</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                            </div>
                                    ...
                                    <table id="tbl_coordinacion" class="table table-striped table-bordered table-responsive">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th width="80" rowspan="2" style="cursor: pointer;" class="icono" data-index="9">FECHA DE ENTREGA AL CLIENTE<i id="iconFechaEntrega"></i></th>
                                                <th width="80" rowspan="2" style="cursor: pointer;" class="icono" data-index="10">FECHA DE ENTREGA POR OPERACIONES<i id="iconFechaEntregaOperaciones"></i></th>
                                                <th rowspan="2" style="cursor: pointer;" class="icono" data-index="11">RIESGO <i id="iconRiesgo"></i></th>
                                                <th rowspan="2">SEG.</th>
                                            </tr>
                                            <tr>
                                                <th>UBICACIÓN</th>
...
<?php $this->load->view("coordinacion/modal/seguimiento_modal"); ?>
<?php $this->load->view("includes/include_script_datatable"); ?>
<?php $this->load->view("coordinacion/include/coordinacion_script"); ?>
