            ...
            <form id="frm_reproceso">
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group row">
                                <label class="col-md-3 label-control text-left" for="inputReprocesoNuevaFechaEntrega">Nueva Fecha</label>
                                <div class="col-md-9">
                                    <div class="input-group">
                                        <input id="inputReprocesoNuevaFechaEntrega" type="date" class="form-control">
                                    </div>
                                </div>                                                      
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    <button id="buttonCloseReproceso" type="button" class="btn grey btn-outline-secondary" data-dismiss="modal">Cerrar</button>
                    <button id="buttonSaveReproceso" type="submit" class="btn grey btn-outline-primary">Guardar</button>
                </div>
            </form>
        </div>
    </div>
