<div class="modal fade text-left" id="mdlSolicitante" role="dialog" aria-labelledby="myModalLabel8" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary white">
                <h4 class="modal-title" id="myModalLabel8">MANTENIMIENTO DE SOLICITANTES</h4>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table id="tbl_tasacion_solicitante" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        <td colspan="2">
                                            <input id="inputSearchSolicitanteNombre" type="text" class="form-control border-primary">
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>#</th>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="text-left">
                            <span id="conteo_solicitante"></span>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div id="paginacion_solicitante" class="float-right"></div>
                    </div>
                </div>
            </div>
