...
class Conversor {
	...
	function convertir($numero, $simbolo, $moneda)
	{
	    ...
	    return $simbolo . " " . $numero . " (" . $numf . " CON " . $cents . "/100 " . utf8_decode(strtoupper($moneda)) . ")";
	}

	function convertirFactura($numero, $moneda)
	{
	    $num   = str_replace(",", "", $numero);
	    $num   = number_format($num, 2, '.', '');
	    $cents = substr($num, strlen($num) - 2, strlen($num) - 1);
	    ...
	    return 'SON: ' . $numf . " CON " . $cents . "/100 " . strtoupper($moneda);
