(function(d) {
    d.addEventListener("DOMContentLoaded", ()=>{
        ...
        const apiRestListar = 'searchVehiculos';
        ...
        const filters = (link) => {
            ...
            fd.append('vehiculo_coordinacion', inputCoordinacion.value)
            fd.append('vehiculo_solicitante', inputSolicitante.value)
            fd.append('vehiculo_cliente', inputCliente.value)
            fd.append('vehiculo_clase', selectClase.value)
            fd.append('vehiculo_marca', selectMarca.value)
            fd.append('vehiculo_modelo', selectModelo.value)
            fd.append('vehiculo_fecha_desde', inputFechaDesde.value)
            fd.append('vehiculo_fecha_hasta', inputFechaHasta.value)
