...
function addToMapCasa(item) {
    var marker = new google.maps.Marker({
        ...
        icon: 'http://192.168.1.10/appsgi/assets/images/small/home.svg',
        map: map
});
...
function addToMapOficina(item) {
    ...
    var marker = new google.maps.Marker({
        ...
        title: item.solicitante + ', ' + item.FECHA,
        //icon: getIcon(item.streamStatus),
        icon: 'http://192.168.1.10/appsgi/assets/images/small/oficinastest.svg',
...
function addToMapLocalComercial(item) {
    ...
    var marker = new google.maps.Marker({
        ...
        title: item.solicitante + ', ' + item.FECHA,
        //icon: getIcon(item.streamStatus),
        icon: 'http://192.168.1.10/appsgi/assets/images/small/industry2.svg',
        map: map
});
...
function addToMapLocalIndustrial(item) {
    var marker = new google.maps.Marker({
        ...
        title: item.solicitante + ', ' + item.FECHA,
        //icon: getIcon(item.streamStatus),
        icon: 'http://192.168.1.10/appsgi/assets/images/small/industry.svg',
        map: map
});
    marker.addListener('click', function() {
        document.getElementById('solicitante').value = item.solicitante
...
function addToMap(item) {
    var marker = new google.maps.Marker({
        ...
        title: item.solicitante + ', ' + item.FECHA,
        //icon: getIcon(item.streamStatus),
        icon: 'http://192.168.1.10/appsgi/assets/images/small/terreno2.svg',
