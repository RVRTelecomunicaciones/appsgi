(function(d) {
    d.addEventListener('DOMContentLoaded', () => {
        ...
        const apiRestListar = 'searchTasaciones';
        ...
        const labelDepartamento = d.getElementById('lblDepartamento');
        const labelProvincia = d.getElementById('lblProvincia');
        const labelDistrito = d.getElementById('lblDistrito');
                    ...
                    if (registros != false) {
                        const filas = registros.map((item, index) => {
                            ...
                            return `<tr>
                                        ...
                                        <td ${thCoordinacion.classList.contains('hidden') ? 'hidden' : ''}><a id='lnkRegistro' href class='btn btn-secondary btn-sm' data-indice='${index}'>Registrar como</a></td>
                                    </tr>`
                        }).join("");
                        ...
                        if (inputCoordinacion.value == "" && inputSolicitante.value == "" && inputCliente.value == "" && selectPerito.value == "" && selectCCalidad.value == "")
                        ...
                        link_registro.forEach(link => {
                            link.addEventListener('click', function(e) {
                                ...
                                labelDepartamento.innerHTML = registros[indice].departamento_id;
                                labelProvincia.innerHTML = registros[indice].provincia_id;
                                labelDistrito.innerHTML = registros[indice].distrito_id;
                            })
                        });       
                    }
                })
        ...
        $('#selectCCalidad').change(function(event) {
            validarData(1);
        });
        ...
        const botonNoRegistrado = d.getElementById('lnkNoRegistrado');
            ...
            const datosCoordinacion =
                                        {
                                            ...
                                            departamento_id: labelDepartamento.innerHTML,
                                            provincia_id: labelProvincia.innerHTML,
                                            distrito_id: labelDistrito.innerHTML,
                                            tipo_tasacion: 1
                                        };
        ...
        botonNoRegistrado.addEventListener('click', function(e) {
            e.preventDefault();
            const datosCoordinacion =
                                        {
                                            coordinacion_correlativo: labelCoordinacionCorrelativo.innerHTML,
