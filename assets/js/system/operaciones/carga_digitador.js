                ...
                .then((response) => {
                    ...
                    linkIniciarProceso.forEach(link => {
                        link.addEventListener('click', e => {
                            ...
                            fd.append('proceso_enviado_de', '1');
                            fd.append('proceso_enviado_a', '1');
                            fd.append('proceso_observacion', '');
                            fd.append('proceso_estado', '1');
                    ...
                    linkFinalizarProceso.forEach(link => {
                        link.addEventListener('click', e => {
                            ...
                            selectDevivarA.options[1].classList.add('hidden');
